  ...
  <SectionBlock id="dor">
    <div class="max-w-4xl">
      ...
      <p class="mt-3 text-base leading-relaxed text-muted sm:text-lg">
        Na maioria dos casos, o problema não é falta de esforço. É falta de clareza, posicionamento e aderência ao que
        recrutadores avaliam nos primeiros segundos.
      </p>
      <p class="mt-3 text-base leading-relaxed text-muted sm:text-lg">
        Resultado: profissionais competentes acabam perdendo entrevistas para perfis que se comunicam melhor.
      </p>
    </div>
  </SectionBlock>
</template>
